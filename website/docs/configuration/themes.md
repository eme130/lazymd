...
title: Themes
sidebar_position: 2
description: 12 built-in color themes for LazyMD — Dracula, Gruvbox, Nord, Catppuccin, Tokyo Night, and more. Syntax highlighting colors for LaTeX and Python with truecolor support.
...
Syntax highlighting is currently available for **2 languages**: LaTeX and Python.
